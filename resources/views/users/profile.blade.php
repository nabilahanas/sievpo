                            ...
                            <div class="card mb-4">
                                <div class="card-body text-center mt-3 mb-3">
                                    @if ($user->profile_pict)
                                        <img src="{{ asset('storage/profile-pict/' . $user->profile_pict) }}"
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="active tab-pane" id="info">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <p class="text-muted mb-0">{{ $user->role->nama_role }}</p>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <p class="text-muted mb-0">{{ $user->jabatan->nama_jabatan }}</p>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="row">
                                        ...
                                        <div class="tab-pane" id="editpass">
                                            <form class="form-horizontal" method="post" action="{{ route('profile.update-password') }}">
                                                ...
                                                <div class="form-group mb-2">
                                                    <button type="submit" class="btn btn-info2"><i class="fas fa-sync mr-2"></i>Update Password</button>
                                                </div>
                                            </form>
                                        </div>
