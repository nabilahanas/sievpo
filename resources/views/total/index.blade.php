            ...
            <div class="mt-4">
                <div class="tab-content">
                            ...
                            <table id="tkaryawan" class="table table-sm text-nowrap text-hover" style="width=100%">
                                <thead class="thead-successv2">
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="9" style="text-align: center">Tanaman / Pemeliharaan / Persemaian
                                        </th>
                    ...
                    <div class="tab-pane" id="krph">
                        <a class="btn btn-outline-success" href="">Download Excel</a>
                        <div class="card-body table-responsive">
                            <table id="tkrph" class="table table-sm text-nowrap table-hover table-striped"
                                style="width: 100%">
                                <thead class="thead-successv2">
                                    <tr>
                                        <th rowspan="2">No.</th>
                                        <th rowspan="2">Nama</th>
                                        <th rowspan="2">KRPH</th>
                                        <th colspan="32">Tanggal 1 s.d. 31</th>
                                    </tr>
                                    <tr>
                                        <th>1</th>
                                        <th>2</th>
