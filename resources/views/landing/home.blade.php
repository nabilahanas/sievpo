    ...
    <header id="header" class="header d-flex align-items-center">
        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><button type="button" class="btn btn-success" onclick="window.location='/'">Beranda</button>
                    </li>
                    <li class="dropdown"><button class="btn btn-success" href="#about"><span>Tentang Kami</span> <i
                        ...
                        <ul>
                            <li><button class="btn btn-success" onclick="window.location='#'">Drop Down 1</button></li>
                            <li><button class="btn btn-success" onclick="window.location='#'">Drop Down 2</button></li>
                            <li><button type="button" class="btn btn-success" onclick="window.location='#'">Drop Down
                                    3</button></li>
                            <li><button type="button" class="btn btn-success" onclick="window.location='#'">Drop Down
                                    4</button></li>
                        </ul>
                    ...
                    <div class="col-lg-6">
                        <div class="content ps-0 ps-lg-5">
                            ...
                            <div class="position-relative mt-4">
                                <img src="{{ asset('landingpage/assets/img/about-2.jpg') }}"
                ...
                <div class="clients-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><img
                                src="{{ asset('landingpage/assets/img/clients/client-1.png') }}" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{ asset('landingpage/assets/img/clients/client-2.png') }}" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{ asset('landingpage/assets/img/clients/client-3.png') }}" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{ asset('landingpage/assets/img/clients/client-4.png') }}" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{ asset('landingpage/assets/img/clients/client-5.png') }}" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{ asset('landingpage/assets/img/clients/client-6.png') }}" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{ asset('landingpage/assets/img/clients/client-7.png') }}" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{ asset('landingpage/assets/img/clients/client-8.png') }}" class="img-fluid"
                                alt=""></div>
                    </div>
                </div>
        ...
        <section id="stats-counter" class="stats-counter">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <img src="{{ asset('landingpage/assets/img/stats-img.svg') }}" alt=""
                            class="img-fluid">
                    </div>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <article>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('landingpage/assets/img/blog/blog-author-2.jpg') }}"
                    ...
                    <div class="col-xl-4 col-md-6">
                        <article>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('landingpage/assets/img/blog/blog-author-3.jpg') }}"
                                    alt="" class="img-fluid post-author-img flex-shrink-0">
                                <div class="post-meta">
