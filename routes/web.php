...
Route::get('/profilekph', [LandingController::class, 'profile'])->name('profile');
Route::get('/visimisikph', [LandingController::class, 'visimisi'])->name('visimisi');
Route::get('/beritakph', [LandingController::class, 'berita'])->name('berita');
Route::get('/fitur', [LandingController::class, 'fitur'])->name('fitur');
Route::get('/wilayah', [LandingController::class, 'wilayah'])->name('fitur');
Route::get('/datakaryawankph', [LandingController::class, 'datakaryawan'])->name('datakaryawan');
Route::get('/strukturkph', [LandingController::class, 'struktur'])->name('struktur');
